            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <form style="width: 20vw;" class="container" id="uploadForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName" placeholder="请输入你的用户名"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPhone" placeholder="请输入你的手机号"
                            value=<?php echo $_SESSION["telephone"] ?>>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail">邮箱</label>
                        <input type="email" class="form-control" id="exampleInputEmail" placeholder="请输入你的邮箱"
